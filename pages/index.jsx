  ...
  return (
    <div style={{ minHeight: '100vh', background: '#0f172a', color: '#f1f5f9', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '20px' }}>
      <div style={{ textAlign: 'center' }}>
        ...
        <Link href="/upload" style={{ background: 'linear-gradient(135deg, #ff0000, #7c3aed)', color: '#fff', padding: '14px 40px', borderRadius: '8px', textDecoration: 'none', fontSize: '16px', fontWeight: '700', display: 'inline-block' }}>
          📤 Go to Upload Tool
        </Link>
      </div>
    </div>
